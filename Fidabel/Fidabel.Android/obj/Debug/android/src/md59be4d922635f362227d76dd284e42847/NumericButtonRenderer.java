...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Syncfusion.SfDataGrid.XForms.Droid.NumericButtonRenderer, Syncfusion.SfDataGrid.XForms.Android, Version=15.1451.0.33, Culture=neutral, PublicKeyToken=null", NumericButtonRenderer.class, __md_methods);
	}


	public NumericButtonRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
	...
	public NumericButtonRenderer (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == NumericButtonRenderer.class)
	...
	public NumericButtonRenderer (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == NumericButtonRenderer.class)
